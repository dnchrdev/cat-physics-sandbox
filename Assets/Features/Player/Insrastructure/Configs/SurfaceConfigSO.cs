...
{
    [CreateAssetMenu(fileName = "SurfacesConfigSO", menuName = "SO/SurfacesConfigSO")]
    public class SurfacesConfigSO : ScriptableObject
    {
        [field: SerializeField] public Surface DefaultSurface { get; private set; }
        [field: SerializeField] public Surface FlowSurface { get; private set; }
